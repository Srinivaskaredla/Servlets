...
if (category == null || category.isEmpty()) {
	category = "All"; // Default category if none is provided
}
BuyerService buyerService = new BuyerService();
List<Product> productsList = buyerService.browseProductsByCategory(category);
...
<body>
	...
	<script>
		document.querySelector('.filter-toggle').addEventListener(
				'click',
				function() {
					document.querySelector('.filter-slide').classList
							.toggle('show');
				});
